...
var antVol = 1;
var _PORT = 9595; //Http port Node.js server will be listening on. Make sure that this is an open port and its the same as the one defined in MT4 indicator/EA.
	...
	request.addListener("end", function() {
		...
		response.writeHead( 200, {"Content-Type": "text/plain"} );
			...
			if(ms.toString() != "")
			{
				...
				fs.appendFileSync('./querysReconstruccion/_dataEURUSD1.txt', JSON.stringify(reqObj) + ",\n", (err) => {
					if (err) throw err;
